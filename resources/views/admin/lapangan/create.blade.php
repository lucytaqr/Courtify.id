    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambah Data Lapangan</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->

    <div class="col-lg-8">
        <form method="POST" action="/admin/lapangans" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <img class="img-preview-2 img-fluid">
              ...
              <div class="mb-3">
                ...
                <img class="img-preview-3 img-fluid">
